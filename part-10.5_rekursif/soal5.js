...
function kaliTerusRekursif(angka) {
   if (angka <= 9){
    ...
    let digitAngka1 = angka % 10;
    let digitAngka2 = Math.floor(angka/10);
    let digitAngka3 = kaliTerusRekursif(digitAngka2);
    return kaliTerusRekursif(digitAngka1*digitAngka3);
   }
}
